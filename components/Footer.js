...
export default function Footer() {
  return (
    <footer className="bg-white/70 border-t border-black/5 backdrop-blur">
      <div className="max-w-7xl mx-auto py-10 px-6 sm:px-8 lg:px-12 text-center">
        <div className="flex justify-center items-center space-x-6 mb-4">
           {/* LinkedIn icon that links to your LinkedIn profile. */}
          <a
            href="https://www.linkedin.com/in/27rohit/"
            target="_blank"
        ...
        <p className="text-slate font-mono text-xs uppercase tracking-[0.2em]">
